...
import { FaWallet, FaUniversity, FaCheckCircle, FaClock, FaTimes } from "react-icons/fa";
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        {activeTab === 'request' && (
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Request New Withdrawal</h2>
                ...
                >
                  ...
                  {userCampaigns.map(campaign => (
                    <option key={campaign._id} value={campaign._id}>
                      {campaign.title} (Available: ₹{campaign.currentAmount?.toLocaleString() || 0})
                    </option>
                  ))}
                </select>
              </div>
              ...
              <div>
                ...
                {selectedCampaign && (
                  <p className="text-sm text-gray-600 mt-1">
                    Available balance: ₹{selectedCampaign.currentAmount?.toLocaleString()}
                  </p>
                )}
              </div>
