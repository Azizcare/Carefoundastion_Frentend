...
export default function SEO({ 
  ...
  return (
    <Head>
      ...
      <meta name="twitter:site" content="@CareFoundation" />
      <meta name="twitter:creator" content="@CareFoundation" />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "contactPoint": {
              ...
              "email": "support@carefoundation.org"
            },
            "sameAs": [
              "https://facebook.com/carefoundation",
              "https://twitter.com/carefoundation",
