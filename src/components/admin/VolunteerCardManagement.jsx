                ...
                <div>
                  ...
                  >
                    ...
                    {VOLUNTEER_ROLES.map((role, idx) => (
                      <option key={role} value={role}>{VOLUNTEER_CATEGORIES[idx]}</option>
                    ))}
                  </select>
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 mt-2"
