        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-2">
              Upload Main Picture <span className="text-red-500">*</span>
            </label>
          ...
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-2">
              Fundraiser summaries <span className="text-red-500">*</span> <span className="text-gray-500 text-xs font-normal">(Min 20 characters, Max 200 characters)</span>
            </label>
            <textarea
              name="summary"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2">
              <label className="block text-sm font-bold text-gray-700 mb-2">
                Fundraiser Heading <span className="text-red-500">*</span> <span className="text-gray-500 text-xs font-normal">(Min 10 characters, Max 100 characters)</span>
              </label>
              <input
                type="text"
                name="heading"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">
                Fundraiser Contact <span className="text-red-500">*</span> <span className="text-gray-500 text-xs font-normal">(10 digit mobile number)</span>
              </label>
              <input
                type="text"
                name="contact"
            ...
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">
                Start Date Of Campaign <span className="text-red-500">*</span>
              </label>
              <input
                type="date"
                name="startDate"
          ...
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-2">
              Fundraiser Description <span className="text-red-500">*</span> <span className="text-gray-500 text-xs font-normal">(Min 50 characters, Max 5000 characters)</span>
            </label>
