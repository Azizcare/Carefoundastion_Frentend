      ...
      <div className="bg-white rounded-xl shadow-lg border-2 border-gray-200 p-4 backdrop-blur-sm">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            <select value={entriesPerPage} onChange={(e) => setEntriesPerPage(Number(e.target.value))} className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
                  ...
                  <td className="px-4 py-3">
                    {event.picture?.url || event.image ? (
                      <div className="w-20 h-20 relative rounded border">
                        <Image src={event.picture?.url || event.image} alt="Event" fill className="object-cover rounded"/>
                      </div>
                    ) : (
