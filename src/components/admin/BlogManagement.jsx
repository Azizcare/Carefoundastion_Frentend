...
export default function BlogManagement() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Only include featuredImage if it's provided and not empty
      if (formData.featuredImage && formData.featuredImage.trim()) {
        submitData.featuredImage = formData.featuredImage.trim();
      }
  ...
  const handleEdit = (blog) => {
    ...
    setFormData({
      ...
      author: typeof blog.author === 'object' ? blog.author.name || blog.author.email || "" : blog.author || "",
      category: blog.category || "",
      tags: blog.tags?.join(", ") || "",
      featuredImage: typeof blog.featuredImage === 'object' ? blog.featuredImage.url || "" : blog.featuredImage || "",
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-gray-600">
                      {typeof blog.author === 'object' && blog.author !== null 
                        ? blog.author.name || blog.author.email || "Admin"
                        : blog.author || "Admin"}
                    </td>
                    <td className="px-6 py-4">
                      <span
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-3 text-sm text-gray-600 mb-4">
                  ...
                  <span className="text-gray-600">
                    By: {(() => {
                      if (typeof viewingBlog.author === 'object' && viewingBlog.author !== null) {
                        return viewingBlog.author.name || viewingBlog.author.email || "Admin";
                      }
                      return viewingBlog.author ? String(viewingBlog.author) : "Admin";
                    })()}
                  </span>
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium ${
