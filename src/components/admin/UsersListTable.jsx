        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            <select 
              ...
              className="border-2 border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all shadow-sm hover:shadow-md"
            >
            ...
            <div className="relative">
              <input 
                ...
                className="border-2 border-gray-300 rounded-xl pl-10 pr-4 py-2.5 text-sm w-64 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all shadow-sm hover:shadow-md"
              />
                  ...
                  <tr key={user._id} className={`border-b border-gray-200 hover:bg-gradient-to-r hover:from-blue-50 hover:to-green-50 transition-all duration-200 ${idx % 2 === 0 ? 'bg-white' : 'bg-gray-50/30'}`}>
                    ...
                    <td className="px-6 py-4">
                      <select
                        ...
                        className={`px-3 py-1.5 rounded-lg text-xs font-medium border-2 focus:outline-none focus:ring-2 focus:ring-green-500 cursor-pointer transition-all ${
                          user.role === 'admin' ? 'bg-gradient-to-r from-purple-100 to-purple-200 text-purple-700 border-purple-300' :
                          user.role === 'fundraiser' ? 'bg-gradient-to-r from-blue-100 to-blue-200 text-blue-700 border-blue-300' :
                          user.role === 'volunteer' ? 'bg-gradient-to-r from-green-100 to-green-200 text-green-700 border-green-300' :
                          user.role === 'partner' ? 'bg-gradient-to-r from-orange-100 to-orange-200 text-orange-700 border-orange-300' :
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-col gap-1">
                        ...
                        {user.kyc?.isCompleted && (
                          <span className="px-2 py-1 rounded-full text-xs font-bold shadow-sm w-fit bg-gradient-to-r from-blue-400 to-blue-600 text-white">
                            KYC Done
                          </span>
                        )}
                      </div>
                      ...
                      <div className="flex gap-2">
                        {user.isActive ? (
                          <button 
                            ...
                            className="px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white text-xs font-bold rounded-xl hover:from-red-600 hover:to-red-700 transition-all shadow-md hover:shadow-lg"
                          >
                            Block
                          </button>
                        ) : (
