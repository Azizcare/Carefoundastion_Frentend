          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="col-span-2 text-sm text-gray-700">At-EEZ building [BEAT], Ibrahim naimullah Road , Bhendi bazaar , Mumbai - 400003</div>
              </div>
              <div className="grid grid-cols-3 gap-4">
                <div className="text-sm font-medium text-blue-600">Phone</div>
                <div className="col-span-2 text-sm text-gray-700">+91 51-42323114</div>
              </div>
              <div className="grid grid-cols-3 gap-4">
                <div className="text-sm font-medium text-blue-600">Email</div>
                <div className="col-span-2 text-sm text-gray-700">admin@carefoundation.org</div>
              </div>
            </div>
          </div>
        )}
