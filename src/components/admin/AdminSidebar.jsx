...
const sidebarData = {
  ...
  backendContent: [
    ...
    },
    {
      title: "Users",
      icon: <BiUserCircle />,
      children: [{ title: "Registered Users", href: "/admin/users" }],
    },
    {
...
export default function AdminSidebar() {
  ...
  return (
    <aside 
      className={`h-screen bg-gradient-to-b from-white via-gray-50 to-white border-r-2 border-gray-200 fixed left-0 top-0 flex flex-col shadow-xl transition-all duration-300 ease-in-out z-50 ${
