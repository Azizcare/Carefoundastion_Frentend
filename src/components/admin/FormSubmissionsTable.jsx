    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600">Manage all form submissions from volunteers, donors, beneficiaries, and vendors</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all shadow-sm hover:shadow-md"
            />
          </div>
          <select
            value={filterType}
          ...
          <table className="w-full">
            <thead className="sticky top-0 z-10">
              <tr className="bg-gradient-to-r from-green-500 via-blue-500 to-green-500">
                ...
                <th className="px-6 py-4 text-left text-sm font-bold text-white uppercase tracking-wide">Submitted</th>
                ...
                <tr>
                  <td colSpan={6} className="px-6 py-12 text-center">
                    <div className="text-gray-500">
                      ...
                      <p className="text-lg font-semibold">No form submissions found</p>
                  ...
                  >
                    <td className="px-6 py-4">
                      ...
                      {submission.formType === 'vendor' && submission.vendorInfo?.businessName && (
                        <div className="text-xs text-gray-500">🏢 {submission.vendorInfo.businessName}</div>
                      )}
                      {submission.formType === 'partner' && submission.partnerInfo?.organizationName && (
                        <div className="text-xs text-gray-500">🤝 {submission.partnerInfo.organizationName}</div>
                      )}
                      {submission.formType === 'beneficiary' && submission.beneficiaryInfo?.category && (
                        <div className="text-xs text-gray-500">📋 {submission.beneficiaryInfo.category}</div>
                      )}
                      {submission.formType === 'volunteer' && submission.volunteerInfo?.preferredRole && (
                        <div className="text-xs text-gray-500">👤 {submission.volunteerInfo.preferredRole.join(', ')}</div>
                      )}
                    ...
                    <td className="px-6 py-4">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${getTypeBadge(submission.formType)}`}>
                    ...
                    <td className="px-6 py-4 text-sm">
                      <div className="text-gray-700 flex items-center gap-1">
                        <FiMail size={14} />
                        {submission.personalInfo?.email || "N/A"}
                      </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-gray-400 to-gray-500 text-white rounded-lg hover:from-gray-500 hover:to-gray-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
              Previous
            </button>
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
              Next
            </button>
          </div>
            ...
            <div className="p-6 space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                      <p><span className="font-medium">Name:</span> {selectedSubmission.personalInfo?.firstName || ''} {selectedSubmission.personalInfo?.lastName || ''}</p>
                      <p><span className="font-medium">Email:</span> {selectedSubmission.personalInfo?.email || "N/A"}</p>
                      <p><span className="font-medium">Phone:</span> {selectedSubmission.personalInfo?.phone || "N/A"}</p>
                      <p><span className="font-medium">Date of Birth:</span> {selectedSubmission.personalInfo?.dateOfBirth ? new Date(selectedSubmission.personalInfo.dateOfBirth).toLocaleDateString() : "N/A"}</p>
                      <p><span className="font-medium">Gender:</span> {selectedSubmission.personalInfo?.gender || "N/A"}</p>
              ...
              {modalAction === "approve" && (
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl hover:from-green-600 hover:to-green-700 transition-all shadow-lg hover:shadow-xl font-semibold"
                  >
                    Approve Submission
                  </button>
                </div>
              ...
              {modalAction === "reject" && (
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl hover:from-red-600 hover:to-red-700 transition-all shadow-lg hover:shadow-xl font-semibold"
                  >
                    Reject Submission
                  </button>
                </div>
              ...
              {modalAction === "edit" && (
                <form onSubmit={handleEditSubmit} className="space-y-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-3 text-lg">Personal Information</h3>
